...
export default function GameModeSelector() {
  ...
  useEffect(() => {
    ...
    bgImage.src = "https://images.unsplash.com/photo-1529699211952-734e80c4d42b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2942&q=90";
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1529699211952-734e80c4d42b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2942&q=90')] bg-cover bg-center brightness-50" 
          style={{
            transform: hoverEffect.active ? `scale(1.05) translate(${(hoverEffect.x - 50) * -0.02}%, ${(hoverEffect.y - 50) * -0.02}%)` : 'scale(1)',
            ...
            >
              ...
              >
                <div className="relative bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 h-full flex flex-col items-center justify-center transition-all duration-300 group-hover:bg-gray-700/90">
                  ...
                  >
                    <span className={`inline-flex items-center justify-center px-4 py-2 rounded-full text-sm font-medium text-white bg-white/10 group-hover:bg-gradient-to-r ${mode.color} transition-all duration-300 transform group-hover:scale-105`}>
                      Play Now
