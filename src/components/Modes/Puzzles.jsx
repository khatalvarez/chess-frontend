...
import { ChevronRight, Award, Sword, Shield, Users } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto">
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex justify-center">
                            <button className="bg-yellow-500 hover:bg-yellow-400 text-blue-900 font-bold py-2 px-4 rounded flex items-center border-2 border-yellow-600 transform active:translate-y-1 transition-transform">
            ...
            {activeCategory === "mate-in-one" && (
              <div className="bg-gray-900 border-2 border-blue-700 rounded-lg p-6 shadow-lg game-panel">
                ...
                <p className="mb-6 text-blue-100">
                  Practice your checkmate vision with these carefully selected positions. 
                  Find the winning move that leads to an immediate checkmate!
                </p>
